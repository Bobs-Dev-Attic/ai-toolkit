...
import fs from 'fs';
import { TOOLKIT_ROOT, getTrainingFolder, getHFToken, getHfHubCache, getModelsPath } from '../paths';
...
const startAndWatchJob = (job: Job) => {
  ...
  return new Promise<void>(async (resolve, reject) => {
    ...
    // Add the --log argument to the command (upstream run.py still supports -l/--log)
